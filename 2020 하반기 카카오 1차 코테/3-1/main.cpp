...
using namespace std;
priority_queue<
tuple<int, string, string, string, string>
, vector<tuple<int, string, string, string, string>>
, less<tuple<int, string, string, string, string>> > v;
...
//    }
    for(int i=0;i<query.size();i++) {
        ...
        priority_queue<tuple<int, string, string, string, string>, vector<tuple<int, string, string, string, string>>, less<tuple<int, string, string, string, string>>> tv = v;
//        tuple<int, string, string, string, string> tmp = tv.top();
//        cout<<get<0>(tmp)<<'\n';
        while(get<0>(tv.top())>=get<0>(q)) {
//            cout<<get<0>(tv.top())<<'\n';
           if((get<1>(q)=="-" || get<1>(q) == get<1>(tv.top()))
           && (get<2>(q)=="-" || get<2>(q) == get<2>(tv.top()))
           && (get<3>(q)=="-" || get<3>(q) == get<3>(tv.top()))
           && (get<4>(q)=="-" || get<4>(q) == get<4>(tv.top()))) countnum++;
           tv.pop();
        }
